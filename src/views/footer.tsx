...
export const Footer: React.FC = ({ }) => {
    return (
        <div>
            <div className="fixed bottom-0 left-0 right-0 bg-base-200 p-2 lg:p-1 lg:flex justify-between hidden">
            <a href="https://11pxl.com" target="_blank"><img src="./11pxl.png" className="w-20 ml-2 mb-1" /></a>
                <h1 className="font-trash mr-3 mt-1 text-sm uppercase">v0.2_beta</h1>
